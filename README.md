...
* [Example App](https://github.com/OleksNik/bitcoin-android/tree/main/app)
...
The `bitcoin-kit-android` is open source and available under the terms of the [MIT License](https://github.com/OleksNik/bitcoin-android/blob/main/LICENSE)
